...
# -------------------------------------------------------------
st.set_page_config(page_title="Painel Visual Carteira IBOV", layout="wide", page_icon="⭐")
...
if secao == "Painel":
    ...
    # =====================================================================
    # =====================================================================
    # PAINEL EXCLUSIVO – CARTEIRA IBOV
    # =====================================================================
    
    aba_ibov, = st.tabs(["🟦 IBOV"])
